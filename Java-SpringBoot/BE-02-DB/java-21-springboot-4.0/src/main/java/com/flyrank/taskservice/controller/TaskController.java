...
/**
 * REST Controller exposing Task CRUD API endpoints for Java 21 & Virtual Threads.
 */
@RestController
@RequestMapping("/tasks")
@Tag(name = "tasks", description = "Task Management CRUD Endpoints (Java 21 & Virtual Threads)")
public class TaskController {
    ...
    public SequencedCollection<TaskResponse> getTasks(
